...
/* Use case:
// LineTitle - The title of the line block, which will be displayed at the top of the component.
// Items: [{ id, title, body }]
*/
...
export default function LineBlock({
  lineTitle = "Line Block",
  items,
  className = "",
}) {
  return (
    <div>
      <h2 className="text-primary mb-24 text-center text-5xl">{lineTitle}</h2>
